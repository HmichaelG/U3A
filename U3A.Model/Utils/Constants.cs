...
namespace U3A.Model
{
    public static class constants
    {
        ...
        public const string SHORT_DATETIME_FORMAT = "dd-MMM-yyy hh:mm tt";
        public const string SHORT_MONTH_AND_YEAR_FORMAT = "MMM-yyyy";
        public const string LONG_MONTH_AND_YEAR_FORMAT = "MMMM-yyyy";
