...
INSERT INTO [dbo].[SystemSettings]
     ...
     VALUES
           (newid()
           ,'U3A Nambucca Valley Inc'
           ,''
           ,'PO Box 101 Nambucca heads NSW 2448'
           ,'-'
           ,'94 948 200 504'
           ,'contact@u3a.com.au'
           ,'https://u3a.com.au'
...
INSERT INTO [dbo].[Person]
     ...
     SELECT
           ...
           ,[UpdatedOn] = getDate()
           ,2024
           ,null FinancialToTerm
FROM	nambucca.dbo.members
...
INSERT INTO [dbo].[Fee]
     ...
     SELECT
           ...
           ,(select top 1 ID from Person where ConversionID = [Mbr#])
           ,GetDate()
           ,GetDate()
           ,'System Conversion'
           ,0
