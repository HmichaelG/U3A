...
/// <summary>
/// The standard Postmark API, allows all interactions with a Postmark "Server" (send/receive/process/analyze emails).
...
{
    /// <summary>
    /// The authorization header required, in this case, "X-U3A-Functions-Server-Token"
    /// </summary>
    protected override string AuthHeaderName
    {
        get { return "X-U3A-Functions-Server-Token"; }
    }

    /// <summary>
    /// Instantiate the client with authentication (not yet implemented on server).
    /// </summary>
    /// <param name="apiBaseUri">The base uri to use when connecting to the server. You should rarely need to modify this, except if you want to disable TLS (not recommended), or you are using a proxy of some sort to connect to the API.</param>
    /// <param name="serverToken">Used for requests that require server level privileges.</param>
    public APIClient(string serverToken, string apiBaseUri = "")
        : base(apiBaseUri)
    {
    ...
    /// <summary>
    /// Instantiate the client without authentication.
    /// </summary>
    /// <param name="apiBaseUri">The base uri to use when connecting to the server. You should rarely need to modify this, except if you want to disable TLS (not recommended), or you are using a proxy of some sort to connect to the API.</param>
    /// <param name="serverToken">Used for requests that require server level privileges.</param>
    ...
    ///// <returns></returns>
    //public async Task<APIClientResponse> SendMessageAsync(PostmarkMessage message)
    //{
    //    return await ProcessRequestAsync<PostmarkMessage, APIClientResponse>("/email", HttpMethod.Post, message);
    //}
    ...
    //public async Task<IEnumerable<APIClientResponse>> SendMessagesAsync(params PostmarkMessage[] messages)
    //{
    //    return await ProcessRequestAsync<PostmarkMessage[], APIClientResponse[]>("/email/batch", HttpMethod.Post, messages);
    //}
    //#endregion
    ...
    ///// <returns></returns>
    //public async Task<APIClientResponse> BypassBlockedInboundMessage(string messageid)
    //{
    //    return await this.ProcessNoBodyRequestAsync<APIClientResponse>(String.Format("/messages/inbound/{0}/bypass", messageid), verb: HttpMethod.Put);
    //}
    ...
    ///// <param name="messageId"></param>
    ///// <returns></returns>
    //public async Task<APIClientResponse> RetryInboundHookForMessage(string messageId)
    //{
    //    return await this.ProcessNoBodyRequestAsync<APIClientResponse>(String.Format("/messages/inbound/{0}/retry", messageId), verb: HttpMethod.Put);
    //}
    ...
    ///// <returns></returns>
    //public async Task<APIClientResponse> DeleteInboundRuleTrigger(int triggerId)
    //{
    //    return await this
    //        .ProcessNoBodyRequestAsync<APIClientResponse>("/triggers/inboundrules/" + triggerId,
    ...
    ///// <returns></returns>
    //public async Task<APIClientResponse> DeleteTemplateAsync(long templateId)
    //{
    //    return await ProcessNoBodyRequestAsync<APIClientResponse>("/templates/" + templateId, null, HttpMethod.Delete);
    //}
    ...
    ///// <returns></returns>
    //public async Task<APIClientResponse> DeleteTemplateAsync(string templateAlias)
    //{
    //    return await ProcessNoBodyRequestAsync<APIClientResponse>("/templates/" + templateAlias, null, HttpMethod.Delete);
    //}

    //public async Task<APIClientResponse> SendMessageAsync(TemplatedPostmarkMessage emailToSend)
    //{
    //    return await SendEmailWithTemplateAsync(emailToSend);
    //}

    //public async Task<APIClientResponse> SendEmailWithTemplateAsync(TemplatedPostmarkMessage emailToSend)
    //{
    //    return await ProcessRequestAsync<TemplatedPostmarkMessage, APIClientResponse>("/email/withTemplate", HttpMethod.Post, emailToSend);
    //}
    ...
    ///// <returns>The processed messages (Complete with system assigned message IDs)</returns>
    //public async Task<IEnumerable<APIClientResponse>> SendMessagesAsync(params TemplatedPostmarkMessage[] messages)
    //{
    ...
    ///// <param name="messages">A prepared batch of templated messages.</param>
    ///// <returns>The processed messages (Complete with system assigned message IDs)</returns>
    //public async Task<IEnumerable<APIClientResponse>> SendEmailsWithTemplateAsync(params TemplatedPostmarkMessage[] messages)
    //{
    //    var body = new Dictionary<string, object> { ["Messages"] = messages.ToList() };

    //    return await ProcessRequestAsync<Dictionary<string, object>, APIClientResponse[]>("/email/batchWithTemplates", HttpMethod.Post, body);
    //}

    //public async Task<APIClientResponse> SendEmailWithTemplateAsync<T>(string templateAlias, T templateModel,
    ...
    //public async Task<APIClientResponse> SendEmailWithTemplateAsync<T>(long templateId, T templateModel,
    //    string to, string from,
    //    bool? inlineCss = null, string cc = null,
    //    string bcc = null, string replyTo = null,
    //    bool? trackOpens = null,
    ...
    //private async Task<APIClientResponse> InternalSendEmailWithTemplateAsync<T>(object templateReference, T templateModel,
    //    string to, string from,
    //    bool? inlineCss = null, string cc = null,
    //    string bcc = null, string replyTo = null,
    //    bool? trackOpens = null,
    ...
    ///// <param name="configurationId">Configuration id to search for</param>
    ///// <returns></returns>
    //public async Task<APIClientResponse> DeleteWebhookConfigurationAsync(long configurationId)
    //{
    //    return await ProcessNoBodyRequestAsync<APIClientResponse>($"/webhooks/{configurationId}", null, HttpMethod.Delete);
    //}
